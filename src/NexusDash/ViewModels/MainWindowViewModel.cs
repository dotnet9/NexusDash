...
namespace NexusDash.ViewModels
{
    public sealed class MainWindowViewModel : ReactiveObject, IDisposable
    {
        ...
        private async Task RefreshAsync(CancellationToken cancellationToken)
        {
            ...
            await Dispatcher.UIThread.InvokeAsync(() => ApplySnapshot(systemTask.Result, processTask.Result));
        }

        private void ApplySnapshot(SystemMetrics systemMetrics, IReadOnlyList<ProcessMetrics> processes)
        {
            ...
            RebuildProcessTree(processes);
            ProcessTotalCount = processes.Count;
        }
